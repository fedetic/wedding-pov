...
- [ ] **CAP-01**: Organizer can open the organizer dashboard in a native iOS app (Capacitor shell loading the live Railway URL)
- [ ] **CAP-02**: Organizer can open the organizer dashboard in a native Android app (Capacitor shell loading the live Railway URL)
- [ ] **CAP-03**: All API calls from the native app succeed (CORS configured for `capacitor://localhost` on iOS and `http://localhost` on Android)
...
- [ ] **NATIVE-01**: Organizer can share the event QR code PNG via the native OS share sheet (Messages, AirDrop, WhatsApp, email, etc.)
