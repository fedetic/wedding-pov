...
```
Agent(
  prompt="Read /Users/304390/Documents/dev/github/wedding-pov/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/templates/VALIDATION.md`
