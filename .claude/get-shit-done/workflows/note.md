...
- **Global scope**: `/Users/304390/Documents/dev/github/wedding-pov/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/304390/Documents/dev/github/wedding-pov/.claude/notes/`)
...
2. Glob `/Users/304390/Documents/dev/github/wedding-pov/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/304390/Documents/dev/github/wedding-pov/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/304390/Documents/dev/github/wedding-pov/.claude/notes/` — works in any directory
