...
<required_reading>
@/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/references/ai-frameworks.md
@/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/304390/Documents/dev/github/wedding-pov/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/304390/Documents/dev/github/wedding-pov/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/304390/Documents/dev/github/wedding-pov/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/304390/Documents/dev/github/wedding-pov/.claude/agents/gsd-eval-planner.md for instructions.
