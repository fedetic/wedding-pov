...
```bash
INIT=$(node "/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/templates/spec.md.
