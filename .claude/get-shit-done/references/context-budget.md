...
The keys live in `.claude/settings.json` (project) or `/Users/304390/Documents/dev/github/wedding-pov/.claude/settings.json` (global) — **not** in `.planning/config.json`:
