...
@/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/304390/Documents/dev/github/wedding-pov/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
